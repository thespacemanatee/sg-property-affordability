...
Open http://localhost:5173/sg-landed-affordability/
...
Create a new public repository under your account named **`sg-landed-affordability`** (or any other name — see step 4 if you change it). Don't initialize it with README/license/gitignore.
...
git branch -M main
git remote add origin git@github.com:thespacemanatee/sg-landed-affordability.git
git push -u origin main
```

(Use the HTTPS URL `https://github.com/thespacemanatee/sg-landed-affordability.git` if you don't have SSH set up.)
...
Your site will be live at **https://thespacemanatee.github.io/sg-landed-affordability/**
